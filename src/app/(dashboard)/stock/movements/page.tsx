    ...
    <div className="space-y-6">
      ...
      {movements.length === 0 ? (
        ...
        <div className="space-y-2">
          {movements.map(({ movement: m, itemName, itemReference, performerFirstName, performerLastName }: { movement: { id: string; type: string; quantity: number; stockItemId: string; reason: string | null; createdAt: Date }; itemName: string; itemReference: string; performerFirstName: string; performerLastName: string }) => {
