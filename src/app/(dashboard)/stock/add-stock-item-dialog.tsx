        ...
        <CardContent>
          <form action={formAction} className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              ...
              <Input name="barcode" placeholder="Code-barres" />
            </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="space-y-1">
                ...
                <Input name="purchasePrice" type="number" step="0.01" min="0" placeholder="0.00" />
              </div>
              <div className="space-y-1">
                <label className="text-xs text-muted-foreground">Prix vente *</label>
                <Input name="sellingPrice" type="number" step="0.01" min="0" placeholder="0.00" required />
              </div>
              <div className="space-y-1">
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="space-y-1">
                ...
                <Input name="minQuantity" type="number" min="0" defaultValue="0" />
              </div>
              <div className="space-y-1">
                <label className="text-xs text-muted-foreground">Emplacement</label>
                <Input name="location" placeholder="Ex: Etagere A3" />
              </div>
            </div>
